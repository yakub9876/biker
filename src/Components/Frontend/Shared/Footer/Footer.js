          ...
          <div className="footer-details text-white">
            ...
            <ul>
              <li>
                ...
                <span className="ms-3">mdyeakub1948@gmail.com</span>
              </li>
              <li>
                <i className="fas fa-phone-alt"></i>
                <span className="ms-3">+8801882948594</span>
              </li>
              <li>
                <i className="fas fa-map-marker-alt"></i>
                <span className="ms-3">Chatar paia, Senbag, Noakhali</span>
              </li>
            </ul>
          </div>
        </Col>
        <Col className="col-12 col-sm-12 col-md-6 col-lg-6">
          <div className="d-flex footer_right justify-content-around align-items-center text-white">
            <img
              ...
              alt=""
            />
            <p>&copy;Copyright 2021 biker shop by yeakub</p>
          </div>
        </Col>
      </Row>
    </Container>
